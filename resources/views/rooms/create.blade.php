    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="room_no" class="form-control" placeholder="Room Number" value="{{ old('room_no') }}">
                @error('room_no')
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="number" name="max_occupancy" class="form-control" placeholder="Max Occupancy" value="{{ old('max_occupancy') }}">
                @error('max_occupancy')
                <span style='color : red'>{{$message}}</span>
                @enderror
            </div>
